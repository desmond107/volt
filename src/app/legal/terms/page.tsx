...
const sections = [
  {
    ...
    body: `By accessing or using Volt Digital Cards services, you agree to be bound by these Terms of Service. If you do not agree, do not use our services. We may update these terms at any time; continued use constitutes acceptance.`,
  },
  {
    title: "2. Eligibility",
