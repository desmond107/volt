...
const sections = [
  {
    ...
    body: `Volt Digital Cards Technologies is committed to combating money laundering, terrorist financing, and other financial crimes. We comply with the Proceeds of Crime and Anti-Money Laundering Act (POCAMLA) of Kenya and applicable international standards set by the Financial Action Task Force (FATF).`,
  },
  {
